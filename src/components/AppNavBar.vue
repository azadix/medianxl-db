        ...
        <div class="navbar-item py-1">
          ...
          >
            ...
            <svg
              ...
              class="github-link-svg"
              aria-hidden="true"
            >
              <path
                class="github-link-svg-path"
                fill-rule="evenodd"
                clip-rule="evenodd"
...
.github-link:hover .contribute-text {
...
.github-link:hover .github-link-svg {
  transform: scale(1.1);
}

.github-link:hover .github-link-svg-path {
  fill: var(--bulma-info);
}
</style>
