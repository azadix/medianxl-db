## New Skill: Decoy, new bow amazon stationary summon to support phalanx and offload damage received
## Fire at Will:
* Now upgrades decoy and lasts as long as decoy does (whether it's alive or not)
* Now adds 5% cast rate per Base Level
* Added state-icon
* Requires Decoy, unlocks at level 30
* Training Dummies now have combined avg/min/max damage display, as well as damage of each element displayed (average of the last 100 hits)
* Angelic Touch: replaced orange effect due to technical issues, now adds 1000 Life Regen per Second, while under 7000 Life
* Wolf druid notes are incorrect. Harbinger got the larger damage increase (4x), Twisted Claw the smaller (2.5x).
* Fixed a bug that allowed summoning a minion, then still keeping it after said minion count became 0
# Game
## General
...
* Added a new supplementary trade site while we work on an even bigger one! https://median-xl.com/trade/
## Engine
